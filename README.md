...
<img src="https://img.shields.io/badge/-Gemini-4285F4?style=for-the-badge&logo=Google-Gemini&logoColor=white" />
  ...
  <h3 align="center">Renderify | AI-powered Architectural Visualization App</h3>
...
- **[Puter](https://jsm.dev/renderify-puter)** is the underlying cloud computing platform and "Internet OS" that provides the infrastructure; including serverless Workers, permanent file storage, key-value (KV) databases, and hosted AI models.

- **[Puter.js](https://jsm.dev/renderify-puterjs)** is the official JavaScript SDK that allows developers to interact with those cloud services directly from the frontend.

- **[CodeRabbit](https://jsm.dev/renderify-coderabbit)** is an AI-powered code review platform that provides deep insights and automated suggestions to improve code quality and security.

- **[Junie by JetBRains](https://jsm.dev/renderify-junie)** is an AI-driven coding assistant integrated into the development environment to help automate complex logic, refactoring, and prompt engineering.
...
```bash
git clone https://github.com/edprogrammerist/renderify
cd renderify
```
...
```env
VITE_PUTER_WORKER_URL="your_url_puter"
```

Replace the placeholder values with your real credentials. You can get these by signing up at: [**Puter.com**](https://jsm.dev/renderify-puter).
